      ...
      <div className="flex-1">
                  ...
                  >
                      <div className="flex flex-col">
                        <div className="flex items-start gap-3">
                          <span
                            className="flex items-center justify-center font-body flex-shrink-0 mt-0.5"
                          ...
                          <div className="flex flex-col">
                            ...
                            <p className="text-a4 text-white" style={{ marginTop: 2 }}>
                              {h.artworkElement}
                            </p>
                          </div>
                        </div>
                        <p className="text-body font-body leading-relaxed" style={{ color: '#c7c7c7', marginTop: 12 }}>
                          {h.explanation}
                        </p>
                      </div>
                  </div>
        ...
        >
          ...
          <AnimatePresence>
            {mobileRevealed && (
              <motion.div
                ...
                className="px-6 mx-auto flex flex-col items-center"
              >
                {/* Hotspot toggle */}
          ...
          <div className="flex justify-center pb-8">
            <div className="relative rounded-full overflow-hidden" style={{ width: 120, height: 2, backgroundColor: 'rgba(255,255,255,0.15)' }}>
              <div
