...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[42rem] md:h-[80rem] flex items-start md:items-center justify-center relative p-2 md:p-20"
      ref={containerRef}
    >
      <div
        className="pt-10 pb-[24px] md:py-40 w-full relative"
        style={{
          perspective: "1000px",
        }}
      >
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] md:max-w-sm md:aspect-[3/4] w-full border-4 border-[#6C6C6C] p-2 md:p-4 bg-[#222222] rounded-[30px] shadow-2xl"
    >
