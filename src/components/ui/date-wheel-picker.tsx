...
function WheelColumn({
  ...
  return (
    ...
    >
      {/* Selection indicator */}
      <div
        className="absolute left-0 right-0 pointer-events-none z-10 border-y border-white/20"
      ...
      <div
        ...
        style={{ height: centerOffset, background: "linear-gradient(to bottom, rgba(17,17,17,0.95), transparent)" }}
      />

      {/* Bottom gradient */}
      <div
        className="absolute left-0 right-0 bottom-0 pointer-events-none z-20"
        style={{ height: centerOffset, background: "linear-gradient(to top, rgba(17,17,17,0.95), transparent)" }}
      />
